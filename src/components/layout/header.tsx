...
export default function Header() {
  ...
  return (
    <header className="bg-secondary-background shadow-lg rounded-2xl xl:w-5xl w-[95%] flex flex-col lg:flex-row justify-between items-center mx-auto p-4  top-4 left-1/2 -translate-x-1/2 z-50 gap-4 lg:gap-0 fixed md:absolute">
      ...
      <div className="flex justify-between items-center w-full">
        ...
        <div className="hidden lg:flex items-center gap-x-8">
          ...
          <Button
            onClick={() =>
              window.open('/Khaled_Fullstack_Developer.pdf', '_blank')
            }
          >
            My resume
          </Button>
